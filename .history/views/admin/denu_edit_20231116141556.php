...
?>
<h1>value="<?=$denuncia->id_usuario?>"</h1>
...
<div class="container mt-5">
        ...
        <form action="salvar_denuncia.php" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="id_usuario" name="id_usuario" value="<?=$denuncia->id_usuario?>">
            </div>
            <div class="mb-3">
                <label for="id_tipo" class="form-label">Tipo de Denúncia</label>
                <input type="hidden" class="form-control" id="id_tipo" name="id_tipo" required>
            </div>
