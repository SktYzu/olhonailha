...
class denuncia
{
    ...
    {
        $querry = "UPDATE denuncias SET titulo = :titulo, descricao = :descr, foto_denuncia = :fotos, local_denuncia = :local_denuncia, id_usuario = :id_usuario WHERE id_denuncia = :id ";
        $conexao = conexao::conectar();
        $stmt = $conexao->prepare($querry);
        $stmt->bindValue(':titulo', $this->titulo);
